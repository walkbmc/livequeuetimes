...
var EuropaPark = function (_Park) {
    _inherits(EuropaPark, _Park);
    ...
    function EuropaPark() {
        ...
        _classCallCheck(this, EuropaPark);
        ...
        var _this = _possibleConstructorReturn(this, (EuropaPark.__proto__ || Object.getPrototypeOf(EuropaPark)).call(this, options));

        _this[s_apiBase] = options.api_base || "https://api.europapark.de/";
        // accept overriding API version
        _this[s_apiVersion] = options.api_version || "api-5.9";
        // take secret token from options, or default to known token
        _this[s_parkSecretToken] = options.secret_token || "ZhQCqoZp";
        return _this;
    }
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    this.HTTP({
                        ...
                        for (var i = 0, poi; poi = ride_data[i++];) {
                            ...
                            rideNames[poi.code] = ((typeof enName === "undefined" ? "undefined" : _typeof(enName)) !== undefined ? enName.value : false) || ((typeof deName === "undefined" ? "undefined" : _typeof(deName)) !== undefined ? deName.value : "???");
                        }
