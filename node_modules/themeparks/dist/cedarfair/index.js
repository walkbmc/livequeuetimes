...
var CedarFairPark = function (_TE2Park) {
    _inherits(CedarFairPark, _TE2Park);
     ...
     */
    function CedarFairPark() {
        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        _classCallCheck(this, CedarFairPark);

        options.name = options.name || "Cedar Fair Park";

        // change defaults before calling super()
        options.auth_token = options.auth_token || "TW9iaWxlX0FQSTptZXJsNHlVMg==";
        options.api_base = options.api_base || "https://cf.te2.biz/rest/";

        // inherit from base class

        // optional special hour parks
        var _this = _possibleConstructorReturn(this, (CedarFairPark.__proto__ || Object.getPrototypeOf(CedarFairPark)).call(this, options));

        _this[s_specialHours] = options.special_hours || [];
        // make sure we're an array
        _this[s_specialHours] = [].concat(_this[s_specialHours]);
        return _this;
    }
    ...
    _createClass(CedarFairPark, [{
        key: "FindScheduleDataURL",
        value: function FindScheduleDataURL() {
        ...
        key: "FetchStaticScheduleData",
        value: function FetchStaticScheduleData() {
