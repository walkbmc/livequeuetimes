...
var DisneyTokyoPark = function (_Park) {
    ...
    function DisneyTokyoPark() {
        ...
        _this[s_apiVersion] = options.api_version || "1.0.3";
    ...
    _createClass(DisneyTokyoPark, [{
        ...
        value: function FetchWaitTimes() {
            ...
            return this.FetchRideData().then(function (rides) {
                return _this2.FetchWaitTimesJSON().then(function (data) {
        ...
        value: function FetchRideData() {
            ...
            return this.Cache.Wrap("ridedata", function () {
                ...
                return _this3.GetEnglishNames().then(function (englishNames) {
                    // fetch ride data from App API
                    return _this3.HTTP({
                        url: _this3[s_apiBase] + "/rest/v1/facilities",
                        method: "GET",
                        ...
                        for (var i = 0; i < body.attractions.length; i++) {
                            ...
                            if (attr.parkType.toLowerCase() != _this3[s_parkID]) continue;
        ...
        value: function GetEnglishNames() {
            ...
            return this.Cache.Wrap("ridenames", function () {
                // fetch ride names
                return _this4.HTTP({
                    url: "https://www.tokyodisneyresort.jp/en/" + _this4[s_parkID] + "/attraction.html",
                    headers: {
                        "Referer": "https://www.tokyodisneyresort.jp/en/" + _this4[s_parkID] + "/attraction.html",
                        connection: "keep-alive",
                        "User-Agent": _this4[s_webUserAgent]
                    },
                    retryDelay: 1000 * 10
                }).then(function (body) {
                    if (!body) {
        ...
        value: function FetchOpeningTimes() {
            ...
            return this.FetchCalendarJSON().then(function (data) {
                for (var i = 0, day; day = data[i++];) {
                    ...
                    if (day.parkType.toLowerCase() != _this5[s_parkID]) continue;

                    _this5.Schedule.SetDate({
                        date: Moment.tz(day.date, "YYYY-MM-DD", _this5.Timezone),
                        openingTime: Moment.tz(day.date + " " + day.openTime, "YYYY-MM-DD HH:mm", _this5.Timezone),
                        closingTime: Moment.tz(day.date + " " + day.closeTime, "YYYY-MM-DD HH:mm", _this5.Timezone),
