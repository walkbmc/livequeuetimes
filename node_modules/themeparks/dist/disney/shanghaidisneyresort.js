...
var ShanghaiDisneyResortMagicKingdom = function (_DisneyBase) {
    ...
    function ShanghaiDisneyResortMagicKingdom() {
        ...
        return _possibleConstructorReturn(this, (ShanghaiDisneyResortMagicKingdom.__proto__ || Object.getPrototypeOf(ShanghaiDisneyResortMagicKingdom)).call(this, options));
    }

    // override API URLs to use the Shanghai services (facilities data doesn't work for Shanghai using normal WDW URLs?)


    _createClass(ShanghaiDisneyResortMagicKingdom, [{
        key: "AuthURL",
        get: function get() {
